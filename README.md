...
> An Infrastructure as Code pipeline that installs, configures, and monitors a Linux node on a laptop whose broken display rules out the interactive installer.
